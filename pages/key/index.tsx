    ...
    return (
        <Layout.Root navGroup="key" pageTitle="Firmware Keys" canonical="/key">
            ...
            <Layout.Content>
                ...
                <p>
                    With the release of the iPhone came the <A href="/file/format/img2">IMG2</A> format and its container, the <A href="/file/format/8900">8900</A> file.
                    They were used on all <A href="/ios/1">iPhone OS 1.x</A> firmwares.
                    Initially, only the <A href="/file/file/kernelcache">kernelcache</A>, <A href="/file/file/iboot">iBoot</A>, and <A href="/file/wtf">WTF</A> were encrypted, but beginning with <A href="/ios/1/1"><a>iPhone OS 1.1</a></A>, all files were encrypted.
                ...
                <p>
                    Following IMG2 came the <A href="/file/format/img3">IMG3</A> file format.
                ...
                <p>
                    ...
                    This time, they introduced the <A href="/file/format/img4">IMG4</A> file format.
                ...
                <p>
                    Unlike practically every other firmware file in an <A href="/file/format/ipsw"><a>IPSW</a></A>, the <A href="/file/rootFS">root filesystem</A> is different;
                ...
                <p>
                    ...
                    This list also includes firmwares for which there was (as can be told) never an <A href="/file/format/ipsw">IPSW</A>, such as <A href="/ios/4/2">iOS 4.2.5</A> for the <A href="/device/iphone/4">CDMA iPhone 4</A> (<code>iPhone3,3</code>).
